...
class CheckoutActivity : Activity() {
    ...
    fun onFuturePaymentPressed(pressed: View) {
        val intent = Intent(this@CheckoutActivity, PayPalFuturePaymentActivity::class.java)
    ...
    fun onProfileSharingPressed(pressed: View) {
        val intent = Intent(this@CheckoutActivity, PayPalProfileSharingActivity::class.java)
    ...
    protected fun displayResultText(result: String) {
        val resultView:TextView = findViewById(R.id.txtResult)
